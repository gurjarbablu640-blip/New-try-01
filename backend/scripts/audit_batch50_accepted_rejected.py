...
results_file = os.path.join(os.path.dirname(__file__), "..", "data", "runtime_state", "batch_50_audit_results.json")
...
print("================================================================================")
print("                    BATCH 50 AUTONOMOUS AUDIT REPORT                            ")
print("================================================================================")
...
for k, v in failure_funnel.items():
    print(f"  {k:28s}: {v}")
...
# Sort accepted by lead_score descending
...
for idx, r in enumerate(random_rejected, 1):
    ...
    if trig:
        ...
        print(f"  Trigger Found:     None")
    if r.get("facility"):
        print(f"  Facility:          {r['facility'].get('name')} ({r['facility'].get('city')})")
    else:
        print(f"  Facility:          None")
print("\n================================================================================")
