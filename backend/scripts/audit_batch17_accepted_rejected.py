"""Audits accepted and rejected candidates from Batch 17 live autonomous research."""
import json
import os
import random

audit_file = os.path.join(os.path.dirname(__file__), "..", "data", "runtime_state", "batch_17_audit_results.json")
...
print("================================================================")
print("BATCH 17 AUDIT REPORT (50 NEW COMPANIES)")
print("================================================================")
