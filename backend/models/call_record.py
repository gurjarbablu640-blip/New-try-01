...
class CallRecord(Base):
    ...
    buying_signals_detected = Column(JSON, nullable=True)  # list of signals
    ...
    coaching_advice = Column(JSON, nullable=True)  # "What should I have said?" advice & golden moments
